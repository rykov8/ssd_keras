...
Currently only forward pass for 300x300 model is available, please, follow 'SSD.ipynb' for examples. I'm working on training stage and I plan to release it as soon as possible.
